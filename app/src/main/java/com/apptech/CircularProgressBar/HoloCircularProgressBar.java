...
public class HoloCircularProgressBar extends View {
	...
	public HoloCircularProgressBar(final Context context, final AttributeSet attrs, final int defStyle) {
		...
		setProgressColor(attributes.getColor(R.styleable.HoloCircularProgressBar_progress_color, Color.parseColor("#FFFFFFFF")));//"#33356C"//#88FFFFFF"))); //custom color by ashiq
		setProgressBackgroundColor(attributes.getColor(R.styleable.HoloCircularProgressBar_progress_background_color, Color.parseColor("#66FFFFFF"))); //#FFFFFF//custom color by ashiq
		...
		mIsThumbEnabled = attributes.getBoolean(R.styleable.HoloCircularProgressBar_thumb_visible, false); //custom disable thumb
		mIsMarkerEnabled = attributes.getBoolean(R.styleable.HoloCircularProgressBar_marker_visible, false); //custom disable marker

		mGravity = attributes.getInt(R.styleable.HoloCircularProgressBar_android_gravity, Gravity.CENTER);

		attributes.recycle();

		mThumbRadius = mCircleStrokeWidth * 4;
...
// --Commented out by Inspection START (28-Apr-15 7:01 PM):
//	/**
...
//	}
// --Commented out by Inspection STOP (28-Apr-15 7:01 PM)
...
// --Commented out by Inspection STOP (28-Apr-15 7:01 PM)
	 ...
	 */
	private void setMarkerProgress(final float progress) {
