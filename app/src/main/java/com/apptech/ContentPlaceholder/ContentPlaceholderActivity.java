package com.apptech.ContentPlaceholder;
...
public class ContentPlaceholderActivity extends AppCompatActivity {

    private static final String TAG = ContentPlaceholderActivity.class.getSimpleName();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_content_placeholder, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.action_profile) {
            startActivity(new Intent(ContentPlaceholderActivity.this, ProfileActivity.class));
            return true;
        }
